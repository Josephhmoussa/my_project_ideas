...
class S3Client:
    ...
    def get_paths_from_folder(self, folder_name: str) -> set[str]:
        ...
        try:
            ...
            dagster_logger.warning(f"Could not process object paths: {e}")
            raise Exception(f"Could not process object paths: {e}")
    ...
    def download_file(self, source_path: str):
        ...
        try:
            ...
            dagster_logger.warning(f"Could not get object: {e}")
            raise Exception(f"Could not get object: {e}")
    ...
    def upload_bytes(self, target_path: str, data: bytes):
        ...
        try:
            ...
            dagster_logger.warning(f"Could not upload to target path: {e}")
            raise Exception(f"Could not upload to target path: {e}")
    ...
    def get_csv_to_dataframe(self, source_path: str, schema_overrides: dict) -> pl.DataFrame:
        ...
        try:
            ...
            dagster_logger.warning(f"Could not load csv file: {e}")
            raise Exception(f"Could not load csv file: {e}")
    ...
    def get_parquet_to_dataframe(self, source_path: str) -> pl.DataFrame:
        ...
        try:
            ...
            dagster_logger.warning(f"Could not load parquet from source path {e}")
            raise Exception(f"Could not load parquet from source path {e}")
    ...
    def get_flat_json_to_dataframe(self, source_path: str) -> pl.DataFrame:
        ...
        try:
            ...
            dagster_logger.warning(f"Could not load json from source path: {e}")
            raise Exception(f"Could not load json from source path: {e}")
    ...
    def upload_dataframe_to_S3(self, target_path: str, df: pl.DataFrame):
        ...
        try:
            ...
            dagster_logger.warning(f"Could not upload dataframe to target path: {e}")
            raise Exception(f"Could not upload dataframe to target path: {e}")